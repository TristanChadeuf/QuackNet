...
#[ORM\UniqueConstraint(name: 'UNIQ_IDENTIFIER_EMAIL_DUCKNAME', fields: ['email', 'duckname'])]
#[UniqueEntity(fields: ['email', 'duckname'], message: 'There is already an account with this email')]
